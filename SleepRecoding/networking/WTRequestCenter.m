...
+(NSURLRequest*)getWithURL:(NSString*)url
                ...
                parameters:(NSDictionary *)parameters
                  ...
                  finished:(WTRequestFinishedBlock)finished
                    failed:(WTRequestFailedBlock)failed
{
    NSURLRequest *request = [[WTURLRequestSerialization sharedRequestSerialization]requestWithMethod:@"GET" URLString:url header:headers parameters:parameters error:nil];
...
+(NSURLRequest*)postWithURL:(NSString*)url
                 ...
                 parameters:(NSDictionary*)parameters
                   finished:(WTRequestFinishedBlock)finished
                     failed:(WTRequestFailedBlock)failed
{
    NSURLRequest *request = [[WTURLRequestSerialization sharedRequestSerialization]requestWithMethod:@"POST" header:headers URLString:url parameters:parameters error:nil];
    [self doURLRequest:request finished:finished failed:failed];
    return request;
}
...
+(NSURLRequest*)putWithURL:(NSString*)url
                ...
                parameters:(NSDictionary*)parameters
                  finished:(WTRequestFinishedBlock)finished
                    failed:(WTRequestFailedBlock)failed
{
    NSURLRequest *request = [[WTURLRequestSerialization sharedRequestSerialization] requestWithMethod:@"PUT" header:header URLString:url parameters:parameters error:nil];
    [self doURLRequest:request finished:finished failed:failed];
    return request;
}
