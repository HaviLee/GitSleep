...
@synthesize seasonMonths = _seasonMonths;
...
- (NSArray*)providers
{
    ...
    return [NSArray arrayWithObjects:
            ...
            (self.seasonMonths != nil) ? self.seasonMonths:null,
            nil];
}
...
- (void)setSeasonMonths:(id<ABCalendarPickerDateProviderProtocol>)seasonMonths
{
    _seasonMonths = seasonMonths;
    [seasonMonths setDateOwner:self];
    [seasonMonths setCalendar:self.calendar];
