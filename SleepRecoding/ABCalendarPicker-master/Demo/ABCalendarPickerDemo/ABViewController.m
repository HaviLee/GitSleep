...
{
    self.calendarPicker.erasProvider = [[ABCalendarPickerDefaultSeasonedMonthsProvider alloc]init];
//    if (sender.selectedSegmentIndex == 0)
...
- (void)viewDidLoad
{
    ...
    [self.calendarPicker setState:ABCalendarPickerStateEras animated:YES];
