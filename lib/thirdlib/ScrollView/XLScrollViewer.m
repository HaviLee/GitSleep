...
-(void)addScroll2{
    ...
    CGPoint point = CGPointMake(self.initialIndex*screen_width, 0);
...
-(void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    [self.scrollDelegate currentPageIndex:scrollView.contentOffset.x/screen_width];//获取当前页数
    for (UIButton *temp in self.buttons) {
