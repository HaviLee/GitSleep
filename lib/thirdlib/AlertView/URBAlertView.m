...
- (void)drawRect:(CGRect)rect {
	...
	// background gradient背景颜色
	CGColorSpaceRef colorSpace = CGColorSpaceCreateDeviceRGB();
	size_t count = 3;
	CGFloat locations[3] = {0.0f, 0.57f, 1.0f};
	CGFloat components[12] =
    {
        25.0f/255.0f, 25.0f/255.0f, 25.0f/255.0f, 0.8f,     //1
        25.0f/255.0f, 25.0f/255.0f, 25.0f/255.0f, 0.8f,     //2
        25.0f/255.0f, 25.0f/255.0f, 25.0f/255.0f, 0.8f      //3
    };
