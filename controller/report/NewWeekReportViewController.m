...
@interface NewWeekReportViewController ()<SelectedWeek,UIScrollViewDelegate,UITableViewDataSource,UITableViewDelegate>
//切换月份
...
@implementation NewWeekReportViewController
